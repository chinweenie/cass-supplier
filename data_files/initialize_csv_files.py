...
def process_orders_by_customer():
    ...
    customers_df = pandas.read_csv(FILEDIR+'customer_df.csv')
...
def process_top_balances():
    customer_df = pandas.read_csv(FILEDIR+'customer_df.csv').loc[:, ['c_id', 'c_w_id', 'c_d_id', 'c_balance', 'c_name']]
...
def process_related_customers_txns():
    ...
    orders_by_warehouse_district_customer_df.to_csv(FILEDIR+'orders_by_warehouse_district_customer_df.csv', index=False)
