...
def process_warehouse():
    warehouse_df = pandas.read_csv('/temp/teamd-cass/data_files/warehouse.csv', dtype=str, header=None)
    ...
    warehouse_df.to_csv('/temp/teamd-cass/data_files/warehouse_df.csv',index=False, sep=',')


def process_district():
    district_df = pandas.read_csv('/temp/teamd-cass/data_files/district.csv',header=None)
    ...
    district_df.to_csv('/temp/teamd-cass/data_files/district_df.csv',index=False)

def process_items():
    item_df = pandas.read_csv('/temp/teamd-cass/data_files/item.csv', header=None)
    item_df.columns = ['i_id', 'i_name', 'i_price', 'i_im_id', 'i_data']
    item_df.to_csv('/temp/teamd-cass/data_files/item_df.csv',index=False)

def process_order():
    order_df = pandas.read_csv('/temp/teamd-cass/data_files/order.csv', header=None)
    order_df.columns = ['o_w_id', 'o_d_id', 'o_id', 'o_c_id', 'o_carrier_id', 'o_ol_cnt', 'o_all_local', 'o_entry_d']
    order_df.to_csv('/temp/teamd-cass/data_files/order_df.csv',index=False)

def process_orders_by_customer():
    orders_df = pandas.read_csv('/temp/teamd-cass/data_files/order_df.csv')
    customers_df = pandas.read_csv('/temp/teamd-cass/data_files/customer_df.csv')
    ...
    orders_by_customer_df.to_csv('/temp/teamd-cass/data_files/orders_by_customer_df.csv', index=False)

def process_order_line():
    order_line_df = pandas.read_csv('/temp/teamd-cass/data_files/order-line.csv', header=None)
    ...
    order_line_df.to_csv('/temp/teamd-cass/data_files/order_line_df.csv',index=False)

def process_stock():
    stock_df = pandas.read_csv('/temp/teamd-cass/data_files/stock.csv', header=None)
    ...
    stock_df.to_csv('/temp/teamd-cass/data_files/stock_df.csv',index=False)

def process_customer():
    customer_df = pandas.read_csv('/temp/teamd-cass/data_files/customer.csv', header=None)
    ...
    customer_df.to_csv('/temp/teamd-cass/data_files/customer_df.csv',index=False)


def process_top_balances():
    customer_df = pandas.read_csv('/temp/teamd-cass/data_files/customer_df.csv').loc[:, ['c_id', 'c_w_id', 'c_d_id', 'c_balance', 'c_name']]
    warehouses_df = pandas.read_csv('/temp/teamd-cass/data_files/warehouse_df.csv').loc[:, ['w_id', 'w_name']]
    districts_df = pandas.read_csv('/temp/teamd-cass/data_files/district_df.csv').loc[:, ['d_w_id','d_id', 'd_name']]
    ...
    final_merged_df.to_csv('/temp/teamd-cass/data_files/top_balances_df.csv', index=False)
...
def process_undelivered_orders_by_warehouse_district():
    orders_by_wd_df = pandas.read_csv('/temp/teamd-cass/data_files/order_df.csv')
    ...
    undelivered_orders_by_wd_df.to_csv('/temp/teamd-cass/data_files/undelivered_orders.csv', index=False)
...
def process_related_customers_txns():
    ...
    order_line_df = pandas.read_csv('/temp/teamd-cass/data_files/order_line_df.csv')
    ...
    orders_by_warehouse_district_customer_df.to_csv('/temp/teamd-cass/data_files/orders_by_warehouse_district_customer_df.csv', index=False)
...
def process_storage_under_threshold():
    order_line_df = pandas.read_csv("/temp/teamd-cass/data_files/order_line_df.csv")
    stock_df = pandas.read_csv("/temp/teamd-cass/data_files/stock_df.csv")
    ...
    df.to_csv('/temp/teamd-cass/data_files/storage_under_treshold.csv', index=False)

# for txn 2.6
def process_popular_items():
    district_df = pandas.read_csv("/temp/teamd-cass/data_files/district_df.csv")
    order_df = pandas.read_csv("/temp/teamd-cass/data_files/order_df.csv")
    customer_df = pandas.read_csv("/temp/teamd-cass/data_files/customer_df.csv")
    item_df = pandas.read_csv("/temp/teamd-cass/data_files/item_df.csv")
    order_line_df = pandas.read_csv("/temp/teamd-cass/data_files/order_line_df.csv")
    ...
    df.to_csv('/temp/teamd-cass/data_files/popular_items_table.csv', index=False)
