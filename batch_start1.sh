...
srun --nodes=1 --ntasks=1 --cpus-per-task=4 --nodelist=xcnd30 bash -c "python $CASS_DIR/xact_files/app.py 192.168.48.249 ${shuffled_array[0]} ${shuffled_array[1]} ${shuffled_array[2]} ${shuffled_array[3]}" &
